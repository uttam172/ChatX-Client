export const chatThemes = {
    ...
    cosmic: {
        ...
        bubbleSent: "bg-radial-[at_25%_20%] from-indigo-600 via-indigo-700 to-purple-600 to-90% text-white rounded-br-sm shadow-[0_4px_15px_rgba(99,102,241,0.2)]",
        bubbleReceived: "bg-radial-[at_25%_20%] from-gray to-zinc-500 to-75% backdrop-blur-md text-white rounded-bl-sm shadow-[0_4px_15px_rgba(0,0,0,0.15)]",
        accentColor: "indigo"
    },
    cyberpunk: {
        id: "cyberpunk",
        ...
        bubbleSent: "bg-radial-[at_25%_20%] from-fuchsia-600 via-pink-600 to-rose-600 to-90% text-white rounded-br-sm shadow-[0_4px_15px_rgba(219,39,119,0.3)]",
        bubbleReceived: "bg-radial-[at_25%_20%] from-gray to-zinc-500 to-75% backdrop-blur-md text-fuchsia-100 rounded-bl-sm shadow-[0_4px_15px_rgba(219,39,119,0.1)]",
        accentColor: "pink"
    },
    sunset: {
        id: "sunset",
        ...
        bubbleSent: "bg-radial-[at_25%_20%] from-amber-500 via-orange-600 to-rose-600 to-90% text-white rounded-br-sm shadow-[0_4px_15px_rgba(249,115,22,0.3)]",
        bubbleReceived: "bg-radial-[at_25%_20%] from-gray to-zinc-500 to-75% backdrop-blur-md text-amber-100 rounded-bl-sm shadow-[0_4px_15px_rgba(249,115,22,0.08)]",
        accentColor: "orange"
    },
    emerald: {
        id: "emerald",
        ...
        bubbleSent: "bg-radial-[at_25%_20%] from-emerald-600 via-teal-600 to-cyan-600 to-90% text-white rounded-br-sm shadow-[0_4px_15px_rgba(16,185,129,0.3)]",
        bubbleReceived: "bg-radial-[at_25%_20%] from-gray to-zinc-500 to-75% backdrop-blur-md text-emerald-100 rounded-bl-sm shadow-[0_4px_15px_rgba(16,185,129,0.08)]",
        accentColor: "emerald"
    },
    midnight: {
        id: "midnight",
        ...
        bubbleSent: "bg-radial-[at_25%_20%] from-cyan-600 via-blue-600 to-indigo-600 to-90% text-white rounded-br-sm shadow-[0_4px_15px_rgba(6,182,212,0.3)]",
        bubbleReceived: "bg-radial-[at_25%_20%] from-gray to-zinc-500 to-75% backdrop-blur-md text-cyan-100 rounded-bl-sm shadow-[0_4px_15px_rgba(6,182,212,0.08)]",
        accentColor: "cyan"
    },
    rose: {
        id: "rose",
        ...
        bubbleSent: "bg-radial-[at_25%_20%] from-rose-500 via-pink-500 to-rose-600 to-90% text-white rounded-br-sm shadow-[0_4px_15px_rgba(244,63,94,0.3)]",
        bubbleReceived: "bg-radial-[at_25%_20%] from-gray to-zinc-500 to-75% backdrop-blur-md text-rose-100 rounded-bl-sm shadow-[0_4px_15px_rgba(244,63,94,0.08)]",
        accentColor: "rose"
    }
};
